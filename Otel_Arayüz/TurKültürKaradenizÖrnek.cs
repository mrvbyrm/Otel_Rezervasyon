...
{
    public partial class TurKültürKaradenizÖrnek : Form
    {
        public TurKültürKaradenizÖrnek()
        {
            InitializeComponent();
        }
        ...
        {
            belirsizsayfa f1 = new belirsizsayfa();
            this.Close();
            f1.Show();
        }
        ...
        {
            TurKültürKaradeniz n = new TurKültürKaradeniz();
            this.Hide();
            n.Show();
        }
