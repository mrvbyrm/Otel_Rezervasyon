...
{
    public partial class TurYurtDışıBalkanÖrnek3 : Form
    {
        public TurYurtDışıBalkanÖrnek3()
        {
            InitializeComponent();
        }
        ...
        {
            belirsizsayfa g = new belirsizsayfa();
            this.Close();
            g.Show();
        }
        ...
        {
            TurYurtDışıBalkan tb = new TurYurtDışıBalkan();
            this.Hide();
            tb.Show();
        }
    }
